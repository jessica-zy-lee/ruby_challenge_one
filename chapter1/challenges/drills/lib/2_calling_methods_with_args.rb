...
def starts_with_the_letter_a?(string)
  # your code goes here
  starts_letter_a = string.start_with? "a"
end
...
def ends_with_the_letter_a?(string)
  # your code goes here
  ends_letter_a = string.end_with? "a"
end
...
def substitute_hello_with_goodbye(string)
  # your code goes here
  substitute_hello_goodbye = string.gsub("hello","goodbye")
end
...
def remove_all_vowels(string)
  # your code goes here
  remove_vowels = string.downcase.delete("aeiou")
end
...
def remove_all_consonants(string)
  # your code goes here
  remove_consonants = string.downcase.delete("bcdfghjklmnpqkrtvwxyz")
end
...
def first_half(string)
  # your code goes here
  mid = string.length / 2
  removed_first_half = string[0...mid]
end
...
def second_half(string)
  # your code goes here
  mid = string.length / 2
  removed_second_half = string[mid..string.length]
end
