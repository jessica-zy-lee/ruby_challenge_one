...
def block_caps_a_string(string)
  # your code goes here
  blocked_caps_string = string.upcase
end
...
def swap_the_case_of_a_string(string)
  # your code goes here
  swap_case_string = string.swapcase
end
...
def swap_the_case_of_a_symbol(symbol)
  # your code goes here
  swap_case_symbol = symbol.swapcase
end
...
def block_caps_a_symbol(symbol)
  # your code goes here
  block_caps_symbol = symbol.upcase
end
...
def lower_case_a_symbol(symbol)
  # your code goes here
  lower_case_symbol = symbol.downcase
end
